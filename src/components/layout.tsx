  ...
  return (
    <>
      ...
      <footer className={"flex flex-col items-center p-2"}>
        <p>telefon: <a href={"tel:+420733113525"} className={"text-primary"}>+420 733 113 525</a></p>
        <p>email: <a href={"mailto:bendova@lamuza.cz"} className={"text-primary"}>bendova@lamuza.cz</a></p>
